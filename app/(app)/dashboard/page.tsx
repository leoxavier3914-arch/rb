...
function isStatsResponse(value: Record<string, unknown>): value is StatsResponse {
...
function isTopProductsResponse(value: Record<string, unknown>): value is TopProductsResponse {
